...
?>
		...
		<div class="content <?php echo $content_class; ?>">
			...
			<?php if ( get_option("tribusThemeSiteTitleText") == 1 ) { ?>
				<div class="logo">
				<?php 
					global $Tribus; 
        ...
        <?php $hide = get_settings('tribusHideSearchForm'); ?>
          ...
          <?php dynamic_sidebar('search-form-area-widget'); ?>
			...
			<?php if ( $content_class == 'interior' && !$hide) { ?>
			...
			<script type="text/javascript"> 
				...
				jQuery(function($){
                  ...
                  qObj['<?php echo get_option('tribusDefaultAreaName'); ?>'] = escape('<?php echo get_option('tribusDefaultAreaValue'); ?>');
							  }
								// debugger;
							} else {
								qObj[v] = $("#" + v).val();
