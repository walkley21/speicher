...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
	...
	<div id="post-<?php the_ID() ?>" class="category">
		...
		<div class="byline">
			<?php the_time('F jS, Y') ?> by <a href="<?php bloginfo('url'); ?>/author/<?= the_author_meta('user_login');?>"<? the_author();?>"><?php the_author_meta('first_name'); ?> <?php the_author_meta('last_name'); ?></a>
