...
<?php $content_class = ( is_home() && !defined('INTERIOR') ) ? 'home' : 'interior'; ?>
	...
	<div class="innerBody">
		...
		<div class="toplinks">
            <p class="website-title"><?php bloginfo( 'name' );?></p>
            
			<!--p class="email"><a href="<?php //echo get_bloginfo('url'); ?>/forms/email-us/?iframe=true&width=450&height=500" class="prettyPhoto">Email Us</a></p-->
            ...
            <?php } ?>
            <p class="phone-text">For More Information On This Community</p>
...
?>
			<a href="<?php echo $fb; ?>" target="_blank" rel="nofollow"><img id="social-img" src="<?php echo bloginfo('stylesheet_directory'); ?>/images/sn_fb.png" alt="facebook"/></a>
			<?php } ?>
...
?>
			<a href="<?php echo $tw; ?>" target="_blank" rel="nofollow"><img id="social-img" src="<?php echo bloginfo('stylesheet_directory'); ?>/images/sn_tw.png" alt="twitter"/></a>
			<?php } ?>
...
?>
			<a href="<?php echo $gp; ?>" target="_blank" rel="author"><img id="social-img" src="<?php echo bloginfo('stylesheet_directory'); ?>/images/sn_gp.png" alt="Google Plus"/></a>
			<?php } ?>
...
?>
			<a href="<?php echo $li; ?>" target="_blank" rel="nofollow"><img id="social-img" src="<?php echo bloginfo('stylesheet_directory'); ?>/images/sn_li.png" alt="linked in"/></a>
			<?php } ?>
...
?>
			<a href="<?php echo $yt; ?>" target="_blank" rel="nofollow"><img id="social-img" src="<?php echo bloginfo('stylesheet_directory'); ?>/images/sn_yt.png" alt="youtube"/></a>
			<?php } ?>
...
?>
			<a href="<?php echo $fl; ?>" target="_blank" rel="nofollow"><img id="social-img" src="<?php echo bloginfo('stylesheet_directory'); ?>/images/sn_fl.png" alt="flickr"/></a>
			<?php } ?>
...
?>
			<a href="<?php echo $rs; ?>" target="_blank" rel="nofollow"><img id="social-img" src="<?php echo bloginfo('stylesheet_directory'); ?>/images/sn_rss.png" alt="rss"/></a>
			<br class="clear">
		</div>
		...
		<div class="content <?php echo $content_class; ?>">
            ...
            <div class="header">
				...
				?>
                <img src="<?php echo bloginfo('stylesheet_directory'); ?>/images/community-homes.jpg" alt="Community Real States" />
				</div>
				
				
                <div class="sec_nav_container">
                    <?php wp_nav_menu( array( 'theme_location' => 'secondary', 'menu_class' => 'sec_nav', 'container_class' => 'sec_nav' ) ); ?>
                </div>
				...
				<div class="search">
					...
					<div class="searchform">
						...
						<p>
							...
							<input type="checkbox" name="idx-q-PropertyTypes" value="<?php echo get_option('tribusHomeCode'); ?>" checked>
							<label style="margin-right:8px;">Homes</label>
						
							<input type="checkbox" name="idx-q-PropertyTypes" value="<?php echo get_option('tribusCondoCode'); ?>">
							<label>Condos</label>
						</p>
			...
			<div class="main">
                ...
                <?php if( !is_home() && get_option('tribusFacebookApp') == 'Y' ):?>
                    <div class="fb-like" data-href="<?php echo site_url() ?>" data-send="false" data-width="450" data-show-faces="true"></div>
                <?php endif;?>