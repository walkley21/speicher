...
<div id="market-stats-content">
	...
	<div class="stats">
		<h4>Single Family</h4>
		<img src="http://charts.altosresearch.com/altos/app?s=median:r,&ra=c&q=a&st=<?php echo $state; ?>&c=<?php echo $city; ?>&z=<?php echo $zip; ?>&sz=s&ts=e&rt=sf&service=chart&pai=<?php echo PAI; ?>&co=0&endDate=&startDate=" alt="Home Inventory in <?php echo ucwords( urldecode($city) ); ?>, <?php echo $state; ?> <?php if ( $zip != 'a' ) { echo "({$zip})"; } ?>">

		<img src="http://charts.altosresearch.com/altos/app?s=inventory:r,&ra=c&q=a&st=<?php echo $state; ?>&c=<?php echo $city; ?>&z=<?php echo $zip; ?>&sz=s&ts=e&rt=sf&service=chart&pai=<?php echo PAI; ?>&co=0&endDate=&startDate=" alt="Median Price of Homes in <?php echo ucwords( urldecode($city) ); ?>, <?php echo $state; ?> <?php if ( $zip != 'a' ) { echo "({$zip})"; } ?>">

		<img src="http://charts.altosresearch.com/altos/app?s=mean_dom:r,&ra=c&q=a&st=<?php echo $state; ?>&c=<?php echo $city; ?>&z=<?php echo $zip; ?>&sz=s&ts=e&rt=sf&service=chart&pai=<?php echo PAI; ?>&co=0&endDate=&startDate=" alt="Average Days on Market of Homes in <?php echo ucwords( urldecode($city) ); ?>, <?php echo $state; ?> <?php if ( $zip != 'a' ) { echo "({$zip})"; } ?>">

		<img src="http://charts.altosresearch.com/altos/app?s=median_market_heat:r,&ra=c&q=a&st=<?php echo $state; ?>&c=<?php echo $city; ?>&z=<?php echo $zip; ?>&sz=s&ts=e&rt=sf&service=chart&pai=<?php echo PAI; ?>&co=0&endDate=&startDate=" alt="Real Estate Market Index in <?php echo ucwords( urldecode($city) ); ?>, <?php echo $state; ?> <?php if ( $zip != 'a' ) { echo "({$zip})"; } ?>">
	</div>
<?php } ?>
...
<div id="market-stats-content">
	...
	<div class="stats">
		<h4>Condominiums</h4>
		<img src="http://charts.altosresearch.com/altos/app?s=median:r,&ra=c&q=a&st=<?php echo $state; ?>&c=<?php echo $city; ?>&z=<?php echo $zip; ?>&sz=s&ts=e&rt=mf&service=chart&pai=<?php echo PAI; ?>&co=0&endDate=&startDate=" alt="Home Inventory in <?php echo ucwords( urldecode($city) ); ?>, <?php echo $state; ?> <?php if ( $zip != 'a' ) { echo "({$zip})"; } ?>">

		<img src="http://charts.altosresearch.com/altos/app?s=inventory:r,&ra=c&q=a&st=<?php echo $state; ?>&c=<?php echo $city; ?>&z=<?php echo $zip; ?>&sz=s&ts=e&rt=mf&service=chart&pai=<?php echo PAI; ?>&co=0&endDate=&startDate=" alt="Median Price of Homes in <?php echo ucwords( urldecode($city) ); ?>, <?php echo $state; ?> <?php if ( $zip != 'a' ) { echo "({$zip})"; } ?>">

		<img src="http://charts.altosresearch.com/altos/app?s=mean_dom:r,&ra=c&q=a&st=<?php echo $state; ?>&c=<?php echo $city; ?>&z=<?php echo $zip; ?>&sz=s&ts=e&rt=mf&service=chart&pai=<?php echo PAI; ?>&co=0&endDate=&startDate=" alt="Average Days on Market of Homes in <?php echo ucwords( urldecode($city) ); ?>, <?php echo $state; ?> <?php if ( $zip != 'a' ) { echo "({$zip})"; } ?>">

		<img src="http://charts.altosresearch.com/altos/app?s=median_market_heat:r,&ra=c&q=a&st=<?php echo $state; ?>&c=<?php echo $city; ?>&z=<?php echo $zip; ?>&sz=s&ts=e&rt=mf&service=chart&pai=<?php echo PAI; ?>&co=0&endDate=&startDate=" alt="Real Estate Market Index in <?php echo ucwords( urldecode($city) ); ?>, <?php echo $state; ?> <?php if ( $zip != 'a' ) { echo "({$zip})"; } ?>">
	</div>
<?php } 
