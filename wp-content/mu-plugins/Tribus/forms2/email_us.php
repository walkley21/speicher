...
<body>
	<div id="wrapper">
		<h2 class="popup<?php echo $themeColor ?>">Contact Us</h2>
		<div id="content">
			...
			<form action="/forms/email-submit/" method="post" id="commentForm">
				...
				<div class="submit"><input name="submit" class="submit btn btn-success"  type="submit" onClick="return checkFields();" /></div>
...
jQuery(function($){
	$("#commentForm").submit(function(){
		...
		$.post($("#commentForm").attr("action"),$("#commentForm").serialize(),function(){
