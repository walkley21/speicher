...
<div id="FORM-wrapper">
	<h2 class="popup-title popup<?php echo $themeColor ?>">Request More Info</h2>
		<div id="content">
			<form action="/forms/more-submit/" method="post" id="commentForm-more" class="container-fluid popup-form">
...
$("#commentForm-more").submit(function(){
	
	
	var t_f_action = $(this).attr("action");
	alert(t_f_action);
	$.post(t_f_action , $(this).serialize(),function(data){
			$("#modalBody-request-more").css("border","1px solid blue");
			$("#modalBody-request-more").html(data);
